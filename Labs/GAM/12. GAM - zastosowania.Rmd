...
4. W `mgcv` paraetry wygładzania sa wybierane automatycznie przy uzyciu GCV (generalizec cross-validation) lub REML (restricted maximum likelihood)
...
```{r}
mod_mgcv2 <- gam(Overall ~  s(Income) + s(Edu) + Health, data = pisa)
summary(mod_mgcv2)
AIC(mod_lm, mod_mgcv)
