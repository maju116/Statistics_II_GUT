...
1. Można sprawdzić wszystkie kombinacje zmiennych, których jest $2^N$ - kiepski pomysł przy dużej liczbie zmiennych
2. Model regresji krokowej (dodajemy lub odejmujemy jedna zmienną na raz). Model wybierany jest pod wzgledem kryterium informacyjnego $AIC = -2\ell +2N$ - im mniejsze tym lepiej.
