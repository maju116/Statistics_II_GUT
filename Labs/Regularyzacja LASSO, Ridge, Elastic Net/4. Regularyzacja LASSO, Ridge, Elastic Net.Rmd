...
Regresja grzbietowa jest przykładem **regularyzacji normą L^q** gdzie $g=2$:
...
$$
\hat{\beta} = agrmin_{\beta} (-\ell(\beta) + \lambda(\sum_{i=1}^p \alpha|\beta_p| + (1-\alpha)\sum_{i=1}^p \beta_p^2))
$$
```{r}
